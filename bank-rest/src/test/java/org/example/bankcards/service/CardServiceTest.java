...
class CardServiceTest {
    ...
    void testGetUserCardsFiltered() {
        ...
        org.example.bankcards.dto.CardDto dto = new org.example.bankcards.dto.CardDto();
        ...
        try (MockedStatic<CardMapper> mapperMock = mockStatic(CardMapper.class)) {
            ...
            Page<org.example.bankcards.dto.CardDto> result = cardService.getUserCards(ownerId, "ACTIVE", "John", "1234", pageable);
